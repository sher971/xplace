    ...
    <div className="info-section" id="services">
      <div className="info-title-content">
        ...
        <p className="info-description">
          We revolutionize interview preparation, providing a seamless platform
          for honing your skills. Our AI-powered mock interview system offers
          tailored practice sessions designed to elevate your performance.
          Whether you're gearing up for a job interview or admissions process,
          we're here to help you shine.
        </p>
      </div>

      <div className="info-cards-content">
        <Link to="/mentor" className="link-unstyled">
          <InformationCard
        ...
        />
        <Link to="https://vaishakh3.github.io/jobsearch/">
          <InformationCard
            title="Job Search"
        ...
        <InformationCard
          ...
          icon={faBriefcase}
        />
        <Link to="/Quiz" className="link-unstyled">
          <InformationCard
